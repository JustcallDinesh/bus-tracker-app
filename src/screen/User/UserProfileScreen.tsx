    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileImageContainer}>
        {profile.profilePicture ? (
          ...
          <Image source={require('../Components/asset/default-user4.jpeg')} style={styles.profileImage} />
        )}
      </View>
      ...
      <View style={styles.Logoutcontainer}>
        <View style={styles.logSemiContainer}>
          <Icon
            name={"log-out-outline"} size={20} color="#007bff" />
          <Text style={styles.LogoutText} onPress={hnadleLogOut}>LOGOUT </Text>
        </View>
      </View>
