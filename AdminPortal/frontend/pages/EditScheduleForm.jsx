// bus-tracker-admin-frontend/src/pages/EditScheduleForm.jsx
...
function EditScheduleForm() {
  ...
  useEffect(() => {
    const fetchSchedule = async () => {
      ...
      try {
        ...
        setDepartureTimes(scheduleData.departureTimes);
        setDaysOfWeek(scheduleData.daysOfWeek);
        setAssignedBus(scheduleData.assignedBus?._id || "");
        setStartDate(
          scheduleData.startDate ? scheduleData.startDate.substring(0, 10) : ""
        );
        setEndDate(
          scheduleData.endDate ? scheduleData.endDate.substring(0, 10) : ""
        );
  ...
  if (loadingSchedule || loadingRoutes || loadingBuses) {
    return <div className="container mx-auto p-6">Loading data...</div>;
  }

  if (scheduleError || routesError || busesError) {
    return (
      <div className="container mx-auto p-6 text-red-500">
        {scheduleError || routesError || busesError}
      </div>
    );
  }
